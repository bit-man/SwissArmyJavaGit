  ...
  public void testGitMvInvalidInput() {
    ...
    try {
      ...
      assertEquals("Should have null pointer exception or illegal argument exception", 
          ExceptionMessageMap.getMessage("000001") + "  { variableName=[repository path] }", 
          e.getMessage());
    }
    try {
    ...
    try {
      ...
      assertEquals("Should have null pointer exception or illegal argument exception", 
          ExceptionMessageMap.getMessage("000001") + "  { variableName=[destination] }", 
          e.getMessage());
    }
    ...
    try {
      ...
      assertEquals("Should have null pointer exception or illegal argument exception", 
          ExceptionMessageMap.getMessage("000001") + "  { variableName=[options] }", 
          e.getMessage());
    }
  }
}
