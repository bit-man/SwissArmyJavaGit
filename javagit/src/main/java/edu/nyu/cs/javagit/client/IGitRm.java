...
public interface IGitRm {
   ...
   * 
   * @param repoPath
   *          A path within the repository. A non-zero length argument is required for this
   ...
   *              </ul>
   */
  public GitRmResponse rm(String repositoryPath, List<String> files) throws IOException;
