...
public abstract class GitCheckoutResponse implements CommandResponse {
  ...
  /**
   * Gets the state of the response and is true if there were any errors
   * produced in the &lt;git-checkout&gt; output.
   * @return true if there are any errors in the output.
   */
