...
public class GitAddResponse implements CommandResponse {
  ...
  /**
   * Returns the size of the list. This getter method is used by the consumer of this object.
   * 
   * @return size of list.
   */
  ...
  /**
   * If options are set one by one then this method sets the option one at a time. To set multiple
   * options, this method need to be executed multiple times.
   * 
   * @param option
   *          GitAdd command option
   */
   ...
   * @param index
   *          option
   * @return Returns empty string if there are no options provided by GitAdd command or if the index
   *         is less than the size of the options list.
   */
