...
public class GitCheckoutOptions {
   ...
   * if &lt;optB&gt; is null then -b option is not specified. 
   */
  String optB;
  ...
  /**
   * When creating a new branch, set up configuration so that <code>git-pull</code> 
   ...
   * &lt;repository&gt; &lt;refspec&gt;" explicitly. This behavior is the default when 
   * the start point is a remote branch. 
   */
  boolean optTrack;
  /**
   ...
   * option, a three-way merge between the current branch, your working 
   * tree contents, and the new branch is done, and you will be on the 
   * new branch.
   */
  boolean optM;

  /** 
   * Sets the name of the new branch that need to be created
   * from the base branch.
   * @param Name of the new branch.
   */
  public void setOptB(String newBranchName) {
    CheckUtilities.checkStringArgument(newBranchName, "New branch name");
    optB = newBranchName;
  }
   ...
   * @param true if quiet option should be set.
   */
   ...
   * @param true if force should be set, else false.
   */
   ...
   * @param true if the track option should be set, else false.
   */
   ...
   * @param true if noTrack options need to be set, else false.
   */
   ...
   * @param true if reflog option should be set, else false.
   */
   ...
   * @param true if merge need to be used, else false.
   */
