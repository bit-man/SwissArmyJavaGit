...
public class GitAddOptions {
  ...
  /**
   * Update only files that git already knows about, staging modified content for commit 
   * and marking deleted files for removal. 
   */
  ...
  /**
   * If some files could not be added because of errors indexing them, do not abort 
   * the operation, but continue adding the others.
   */
