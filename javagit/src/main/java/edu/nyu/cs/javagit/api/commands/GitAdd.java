...
/**
 * <code>GitAdd</code> provides an interface for adding files or directory
 * tree into git repository
 */
public class GitAdd {
  /**
   ...
   *            Complete command with options and the list of files whose 
   *            content need to be added to the index. files can be file-pattern
   *            as well.
   * @return    results from the add command.
   * @exception IOException
   *            There are many reasons for which an
   *            <code>IOException</code> may be thrown if -
   *            <ul>
   ...
   *            <code>IllegalArgumentException</code> will be thrown.
   * @param options
   *            Options used for running git-add command e.g. -n, or -v or -f 
   *            or a combination of them.
   * @param fileNames 
   *            Filenames and filePattern that will be added to the index by 
   *            git-add command
   * @return    results from the add command.
   * @exception IOException
   *            There are many reasons for which an
   ...
   *            </ul>
   */
	public GitAddResponse add(String repositoryPath, List<String> options, List<String> fileNames) throws IOException{
